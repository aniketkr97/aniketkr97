# Aniket Kumar — Infrastructure & Platform Engineer
...
- Reliability that's designed in, not bolted on
- Systems that heal themselves before users notice
...
| Metric | Result |
|--------|--------|
| Workflow executions managed | 200K+/month across 42+ environments |
| Infrastructure uptime achieved | 99.99% with <15min MTTR |
| Cloud costs reduced | 35% YoY through reserved instances + auto-scaling |
| Cost savings from open-source adoption | $500K+/year |
| Incident resolution improvement | 60% faster, 40 engineering hours saved/week |
| Engineers unblocked via self-service | 20+ backend engineers |
| Daily events handled (ML platform) | 10M+ at 99.9% uptime |
| Security vulnerabilities eliminated | 90% reduction |
